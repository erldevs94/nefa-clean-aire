<template>
  <div class="w-full">
    ...
    <section id="hero" class="w-full pb-24">
      <BaseSection>
        <div class="col-span-12 lg:col-span-6 mt-12 xl:mt-10 space-y-4 sm:space-y-6 px-6 text-center sm:text-left">
          ...
          >
            Your <span class="text-header-gradient">Cool Comfort</span> Our Expert Care
          </h1>
          <p data-aos="fade-down" data-aos-once="true" data-aos-delay="300" class="paragraph hidden sm:block">
            Let's make your air cool and clean with <span class="font-semibold">Clean-Aire</span>
          </p>
          <div
            data-aos="fade-up"
            data-aos-once="true"
        ...
        <div class="hidden sm:block col-span-12 lg:col-span-6">
          <div class="w-full">
            <img
              ...
              data-aos-once="true"
              :src="
                require('~/assets/img/asian-senior-grandparents-couple-laying-with-grandchildren-preety-female-child-bed-bedroomhappy-family-play-together-bed.jpg')
              "
              class="-mt-4"
              alt=""
            />
    ...
    <section id="about" class="bg-white relative max-w-full sm:mx-4 my-20 py-16 shadow rounded-2xl overflow-hidden">
      <div class="relative max-w-screen-xl px-4 sm:px-2 mx-auto grid grid-cols-12 gap-x-6">
        ...
        <div data-aos="fade-right" class="col-span-12 lg:col-span-6 space-y-8 sm:space-y-6 px-4 sm:px-6 mt-8">
          <h2 class="text-4xl font-semibold">About<span class="text-header-gradient"> Clean-Aire</span></h2>
          <div class="space-y-2">
            <h4 class="text-lg font-medium">Trusted and Reliable Service</h4>
            <p class="paragraph text-sm xl:text-base">
              Our aircon services are designed to provide you with exceptional comfort and peace of mind. We understand
              the importance of a well-functioning air conditioning system, especially during hot summer months or in
              tropical climates.
            </p>
          </div>
          <div class="space-y-2">
            <h4 class="text-lg font-medium">Professional Service</h4>
            <p class="paragraph text-sm xl:text-base">
              Our skilled technicians are dedicated to ensuring that your aircon operates at its optimal level,
              delivering cool and refreshing air throughout your space. Whether you need routine maintenance, repairs,
              or installation of a new unit, we have the expertise to meet your needs.
            </p>
          </div>
          <div class="space-y-2">
            <h4 class="text-lg font-medium">Range of expertise</h4>
            <p class="paragraph text-sm xl:text-base">
              Our comprehensive range of services includes thorough inspections, cleaning of filters and coils,
              refrigerant level checks, condenser and evaporator coil cleaning, fan motor lubrication, and overall
              system diagnostics. We strive to enhance the efficiency and longevity of your air conditioning system,
              saving you energy and preventing potential breakdowns.
            </p>
          </div>
    ...
    >
      <div class="w-full py-16 flex flex-col items-center">
        <h2 data-aos="flip-down" class="text-3xl sm:text-4xl font-semibold text-center">Services Offered</h2>
        <div
          data-aos="fade-up"
        ...
        >
          ...
          <!-- <img
            ...
            class="hidden lg:inline-block absolute top-32 left-64 xl:left-[22rem] w-24 xl:w-[15rem]"
            alt=""
          /> -->
          <!-- <img
            :src="require('~/assets/img/getting-started/arrow.png')"
    ...
    <section id="gallery">
      <h2 data-aos="flip-down" class="text-3xl sm:text-4xl font-semibold text-center">Our Gallery</h2>
      <div class="grid grid-cols-2 md:grid-cols-4 gap-4 p-5">
        <div class="grid gap-4">
          <div>
            <img class="h-auto max-w-full rounded-lg" :src="require('~/assets/img/gallery/gallery-1.jpg')" alt="" />
          </div>
          <div>
            <img class="h-auto max-w-full rounded-lg" :src="require('~/assets/img/gallery/gallery-6.jpg')" alt="" />
          </div>
          <div>
            <img class="h-auto max-w-full rounded-lg" :src="require('~/assets/img/gallery/gallery-5.jpg')" alt="" />
          </div>
        </div>
        <div class="grid gap-4">
          <div>
            <img class="h-auto max-w-full rounded-lg" :src="require('~/assets/img/gallery/gallery-3.jpg')" alt="" />
          </div>
          <div>
            <img class="h-auto max-w-full rounded-lg" :src="require('~/assets/img/gallery/gallery-2.jpg')" alt="" />
          </div>
          <div>
            <img class="h-auto max-w-full rounded-lg" :src="require('~/assets/img/gallery/gallery-16.jpg')" alt="" />
          </div>
        </div>
        <div class="grid gap-4">
          <div>
            <img class="h-auto max-w-full rounded-lg" :src="require('~/assets/img/gallery/gallery-8.jpg')" alt="" />
          </div>
          <div>
            <img class="h-auto max-w-full rounded-lg" :src="require('~/assets/img/gallery/gallery-4.jpg')" alt="" />
          </div>
          <div>
            <img class="h-auto max-w-full rounded-lg" :src="require('~/assets/img/gallery/gallery-11.jpg')" alt="" />
          </div>
        </div>
        <div class="grid gap-4">
          <div>
            <img class="h-auto max-w-full rounded-lg" :src="require('~/assets/img/gallery/gallery-14.jpg')" alt="" />
          </div>
          <div>
            <img class="h-auto max-w-full rounded-lg" :src="require('~/assets/img/gallery/gallery-7.jpg')" alt="" />
          </div>
          <div>
            <img class="h-auto max-w-full rounded-lg" :src="require('~/assets/img/gallery/gallery-15.jpg')" alt="" />
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="contact" class="w-full my-24">
      <BaseSection>
        ...
        <div data-aos="fade-right" class="col-span-12 lg:col-span-6 mt-4 xl:mt-20 space-y-6 px-4">
          <h2 class="text-4xl font-semibold sm:pr-8 xl:pr-12">
            Contact Us <br class="hidden sm:block" />
            and Chill Out
          </h2>
          <p class="paragraph">
            Contact us today to schedule an appointment or learn more about how we can meet your air conditioning needs.
          </p>
          ...
          <h4>
            <Mailto mail="louwellcabilan@gmail.com" subject="Aircon Service" body="" title="Write me an email">
              <MailIcon :size="20" />louwellcabilan@gmail.com
            </Mailto>
          </h4>
          <h4>
            <a target="_blank" href="https://www.facebook.com/profile.php?id=100090316867201"
              ><FacebookIcon :size="20" />Louwell Cabilan</a
            >
          </h4>
    ...
    <div class="w-full my-10 flex justify-center">
      ...
      >
        ...
        <ArrowUpIcon :size="20" />
        <ArrowUpRightIcon :size="20" class="h-6 w-6 text-gray-500" />
      </a>
    </div>
  </div>
</template>
      ...
      steps: [
        {
          ...
          description: ['Wall mounted/Split Type', 'Window Type'],
        },
        {
          img: 'ac-3.jpg',
          title: 'Aircon Repair',
